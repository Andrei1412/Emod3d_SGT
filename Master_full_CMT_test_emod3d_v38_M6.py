...
#    strike = 90-strike
    ...
    M6 = Mo * np.array([mxx, myy, mzz, mxy, mxz, myz])
...
#    fid.write("%s\n" %('Med='+str('{:.8e}'.format(M[1,2]))))
    ...
    fid.write("%s\n" %('Mnn='+str('{:.8e}'.format(M[0]))))
    fid.write("%s\n" %('Mee='+str('{:.8e}'.format(M[1]))))
    fid.write("%s\n" %('Mdd='+str('{:.8e}'.format(M[2]))))
    fid.write("%s\n" %('Mne='+str('{:.8e}'.format(M[3]))))
    fid.write("%s\n" %('Mnd='+str('{:.8e}'.format(M[4]))))
    fid.write("%s\n" %('Med='+str('{:.8e}'.format(M[5]))))
