...
#    data_shift[0:n_pts-ndelay_Time] = data[ndelay_Time:n_pts]
            ...
            AA[ishot_id,i,k,:,3] = butter_bandpass_filter(AA[ishot_id,i,k,:,3], lowcut, highcut, fs, order=4)

            AA[ishot_id,i,k,:,2] = butter_bandpass_filter(AA[ishot_id,i,k,:,2], lowcut, highcut, fs, order=4)
            AA[ishot_id,i,k,:,6] = butter_bandpass_filter(AA[ishot_id,i,k,:,6], lowcut, highcut, fs, order=4)

            AA[ishot_id,i,k,:,5] = butter_bandpass_filter(AA[ishot_id,i,k,:,5], lowcut, highcut, fs, order=4)
            AA[ishot_id,i,k,:,7] = butter_bandpass_filter(AA[ishot_id,i,k,:,7], lowcut, highcut, fs, order=4)            
...
#R_Time_record_arr = np.loadtxt('../../Kernels/index_all_ncc_pyflex.txt') 
