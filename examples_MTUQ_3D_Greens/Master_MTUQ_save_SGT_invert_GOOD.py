...
station_id_list = ['NZ.WEL.', 'NZ.NNZ.', 'NZ.THZ.', 'NZ.KHZ.', 'NZ.QRZ.', 'NZ.GVZ.']
...
for i in range(0,len(stations)):
    if(stations[i].station in statnames_RGT):
        stations_BB.append(stations[i])
    
#Write greens to SPECFEM3D format!    
...
greens = db.get_greens_tensors(stations_BB,origin)
