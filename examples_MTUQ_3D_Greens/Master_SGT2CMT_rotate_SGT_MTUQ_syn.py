...
#
            ...
            #Filter Green's function with different filters for bodywave and surfacewave arrivals            
...
#for ishot_id in range(1,2):
    ishot=ishot_arr[ishot_id]
#    mainfolder='Vel_ob_'+str(ishot)+'/'
#    mainfolder='/home/andrei/workspace/GMT_tools/mtuq_src/data/Vel_ob_2_M10/'
    mainfolder='/home/andrei/workspace/GMT_tools/mtuq_src/data/Vel_ob_2_M00/'    
#    mainfolder_o='../../Kernels/Vel_ob_200s_HH_13s/Vel_ob_'+str(ishot)+'/'
#    mainfolder='SAVE_data_bw/'
#    mainfolder='SAVE_data_sw/'
...
#        if((statname in statnames_RGT) and (R_all[i,k,ishot-1]==1)):
        if((statname in statnames) and (R_all[statnames.index(statname),k,ishot-1]==1)):
            ...
            #for k in range(1,2):
                s0=statname+GV[k]            
#                s0='2013p544960.NZ.'+statname+G3[k]
...
#                stat_data_0_O = timeseries.read_ascii(mainfolder+s0)                
