...
#                    traces.remove(trace)
    ...
    #                pass
                    ...
                    t1_old = float(UTCDateTime(2013, 7, 21, 15, 13, 31, 578399))
                    t2_old = float(UTCDateTime(2013, 7, 21, 15, 20, 11, 978399))
                    dt_old = 0.02
            
                    resample(trace, t1_old, t2_old, dt_old, t1_new, t2_new, dt_new)
