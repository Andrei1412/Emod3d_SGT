...
#    df.to_hdf('stations.h5', key='df', mode='w')
#    
##    stations_check = pd.read_hdf('stations.h5',key='df')    
#    f = h5py.File('stations.h5','a')
#    f.create_dataset('df',data=stations,dtype=object)
...
#    syn_sac = SACTrace(kstnm=statname, kcmpnm=GV[k], stla=R[i,1], stlo=R[i,0], evla=S[ishot-1,1], evlo=S[ishot-1,0], evdp=S[ishot-1,2], nzyear=2000, nzjday=1, nzhour=0, nzmin=0, nzsec=0, nzmsec=0,
#                   t0=0, t1=240, delta= dt, b=t_shift, data=gmdata_sim_vi)
